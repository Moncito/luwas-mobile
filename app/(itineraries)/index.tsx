...
export default function ItinerariesList() {
  ...
  const EmptyState = () => (
    <View style={styles.emptyWrap}>
      ...
      <Text style={styles.emptySubtitle}>
        Please check back later for new travel packages.
      </Text>
    </View>
  );
  ...
  return (
    <View style={styles.container}>
      {/* Hero image + overlay */}
      <Animated.View
        style={[styles.heroWrap, { transform: [{ translateY: headerTranslate }] }]}
      >
        <Image
          source={require("../../assets/images/homeitinerary.jpg")}
        ...
        <Animated.View style={[styles.heroTextWrap, { opacity: headerOpacity }]}>
          <Text style={styles.heroTitle}>Itineraries</Text>
          <Text style={styles.heroSubtitle}>
            Pre-planned adventures across the Philippines
          </Text>
        </Animated.View>
      </Animated.View>
